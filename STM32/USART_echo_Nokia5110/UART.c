...
#define GPIOA_CRH_MODE_PA9	0x00000010	// режим <=10 МГц
#define GPIOA_CRH_CNF_PA9		0x00000080	// Установка альтернативной функции (USART1TX) порта A9 на выход, двухтактный выход (push-poll)
#define GPIOA_CRH_MODE_PA10	0x00000000	// Если вход, то MODE всегда "0"
#define GPIOA_CRH_CNF_PA10	0x00000400	// Установка альтернативной функции (USART1RX) порта A10 на вход, плавающий вход (input floating)
...
//	USART_BRR_DIV_Fraction	0x0000000x	//
	...
	GPIOA_CRH &= ~0x00000FF0;							// 11) Очистка битов режима портов PA9 И PA10
	GPIOA_CRH |= GPIOA_CRH_MODE_PA9 | // <10 МГц
							 GPIOA_CRH_CNF_PA9; 	// Альтернативный режим, двухтактный выход порта PA9
	GPIOA_CRH	|= GPIOA_CRH_MODE_PA10 | 
							 GPIOA_CRH_CNF_PA10; 	// Альтернативный режим, плавающий вход порта PA10
}
