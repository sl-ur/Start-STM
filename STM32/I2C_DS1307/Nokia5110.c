...
// Карпов Вячеслав
// 29 мая 2016 г.
// 09 июня 2016 г. Разделено инициализация SPI и Nokia5110.
...
//********Nokia5110_OutBCD*****************
// Output a 8-bit number in BCD
// Inputs: n  8-bit cahr in BCD
// Outputs: none
// assumes: LCD is in default horizontal addressing mode (V = 0)
// Карпов Вячеслав
// 21 июня 2016
void Nokia5110_OutBCD(char n){
  if(n > 9)
    Nokia5110_OutChar('?'); /* Если не двоично-десятичный код (BCD) */
  else
    Nokia5110_OutChar(n+'0'); /* n is between 0 and 9 */
}
